...
function mna_plugin_setting_api_rest_local_id() {
	$options = get_option( 'meat_night_api_options' );
	echo '<label>4700 (PROD)</label>';
	echo "<input id='mna_plugin_setting_api_rest_local_id' name='meat_night_api_options[api_rest_local_id]' type='radio' ".checked( esc_attr( $options['api_rest_local_id'] ), 4700 )." value='4700' />";
	echo '<label>9999 (TEST)</label>';
	echo "<input id='mna_plugin_setting_api_rest_local_id' name='meat_night_api_options[api_rest_local_id]' type='radio' ".checked( esc_attr( $options['api_rest_local_id'] ), 9999 )." value='9999' />";
}
